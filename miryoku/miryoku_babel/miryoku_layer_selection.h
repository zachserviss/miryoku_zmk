...
#include "miryoku_layer_alternatives.h"
    ...
    #endif
  #else
    #if defined (MIRYOKU_ALPHAS_ATPV3)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_ATPV3
    #elif defined (MIRYOKU_ALPHAS_AZERTY)
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
  ...
  #else
    #if defined (MIRYOKU_ALPHAS_ATPV3)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_ATPV3
    #elif defined (MIRYOKU_EXTRA_AZERTY)
    ...
    #else
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_APTV3
    #endif
  #endif
#endif
